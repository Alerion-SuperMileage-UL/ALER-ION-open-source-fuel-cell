...
**Recommendation:** For future development, it might be wiser to start using a thickness closer to the industry standard of 50 µm to obtain a reliable stack, and then go down in thickness to optimise the performance.
