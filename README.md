...
### Membrane CAD file
The CAD file for the membrane can be found at [`CAD files/Membrane.step`](https://github.com/Alerion-SuperMileage-UL/ALER-ION-open-source-fuel-cell/tree/main/CAD%20files).
